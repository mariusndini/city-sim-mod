...
namespace webDistricts
{
    class webDistricts : RequestHandlerBase
    {
        public webDistricts(IWebServer server)
            : base(server, new Guid("8b255904-b82-406e-b5e2-c5a43fdd9bba"), "webDistricts", "Marius", 100, "/webDistricts")
        {  
        }
