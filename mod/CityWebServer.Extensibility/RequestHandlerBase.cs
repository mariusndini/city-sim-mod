...
namespace CityWebServer.Extensibility
{
    public abstract class RequestHandlerBase : IRequestHandler, ILogAppender
    {
        ...
        /// </summary>
        public IResponseFormatter JsonResponse<T>(T content, HttpStatusCode statusCode = HttpStatusCode.OK)
        {
        ...
        /// </summary>
        public IResponseFormatter HtmlResponse(String content, HttpStatusCode statusCode = HttpStatusCode.OK)
        {
        ...
        /// </summary>
        public IResponseFormatter PlainTextResponse(String content, HttpStatusCode statusCode = HttpStatusCode.OK)
        {
